...
import { getConfiguredDistributorsAsync } from "@/lib/reconciliation/column-mappings.server";

export const dynamic = "force-dynamic";

export default async function ReconciliationPage() {
  const [distributors, runs, configuredCodes] = await Promise.all([
    ...
    getConfiguredDistributorsAsync(),
  ]);
  ...
  return (
    <ReconciliationPageClient
      ...
      configuredDistributors={configuredCodes}
    />
  );
}
