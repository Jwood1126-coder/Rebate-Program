...
const navigation = [
  ...
  { name: "Data Quality", href: "/data-quality", icon: DataQualityIcon },
  { name: "Audit Log", href: "/audit", icon: AuditIcon },
  { name: "Settings", href: "/settings", icon: SettingsIcon },
  { name: "Dev Tools", href: "/test-data", icon: DevToolsIcon },
];
...
export function Sidebar() {
  ...
  return (
    <aside className="flex h-full w-56 flex-col bg-brennan-dark text-white">
      {/* Brennan Logo */}
      <div className="flex h-14 items-center gap-2.5 border-b border-white/10 px-4">
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img
          src="/brennan-icon.jpg"
        ...
        />
        <div>
          <p className="text-sm font-semibold leading-tight">Brennan</p>
          <p className="text-[10px] text-white/50">Rebate Management</p>
        </div>
      </div>
      ...
      <div className="border-t border-white/10 px-6 py-3">
        <p className="text-xs text-white/40">RMS v1.0</p>
      </div>
    </aside>
  );
}
...
function DistributorIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
function DevToolsIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
